...
export function articles(){return [
  ...
  ['生存与建设','纤维编织与当前范围','背包中可用 3 份植物纤维，花 15 分钟编织 1 份布料，用于现有庇护所配方。工具和燃料可用于制作照明设备与简易电池；石料暂可携带和储藏，尚无采矿系统。动物活动已加入；玩家战斗、复杂合成和资源恢复仍未加入。'],
